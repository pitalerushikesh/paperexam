...
export const physicsQuestions: Question[] = [
  {
    questionNumber: 1,
    marks: 1,
    content: `What is the effect of humidity on sound waves when humidity increases?
...
<img
  src="https://i.ibb.co/p6rCHT01/4-phys-2025.png"
  alt="graph"
  style="
    float:left;
    width:44%;
...
(d) Insufficient data to draw any conclusion`,
  },
  {
    questionNumber: 5,
    marks: 1,
    content: `A body of mass 2 kg moving with a speed of $4~m/s$ makes an elastic collision with another body at rest and continues to move in the original direction but with one fourth of its initial speed. The speed of the two body centre of mass is:
...
(d) $\\frac{7}{2}R$`,
  },
  {
   ...
   <img
    src="https://i.ibb.co/bg6S5gCH/7-phys-2025.png"
    alt="rod on incline"
    style="
      float:left;
      width:44%;
...
(d) $\\frac{1}{R^2}$`,
  },
  {
    questionNumber: 10,
    marks: 1,
    content: `The work done in increasing the size of a soap film from $10~cm \\times 6~cm$ to $10~cm \\times 11~cm$ is $3 \\times 10^{-4}~J$. The surface tension of the film is:
...
(d) isochoric process`,
  },
  {
    ...
    content: `The current i in the part of the electric circuit shown is: \\
      <img
        src="https://i.ibb.co/p62JtpDs/12-phys-2025.png"
        alt="rod on incline"
        style="
          float:left;
          width:50%;
...
(d) 1 amp`,
  },
  {
    ...
    marks: 1,
    optionFontScale: 1.5,
    content: `Two discs of moment of inertia $I_1$ and $I_2$ and angular speeds $\\omega_1$ and $\\omega_2$ are rotating along collinear axes passing through their centre of mass and perpendicular to their plane. If the two are made to rotate combinedly along the same axis, the rotational KE of the system will be:

(a) $\\frac{I_1\\omega_1+I_2\\omega_2}{2(I_1+I_2)}$ 

(b) $\\frac{(I_1+I_2)(\\omega_1+\\omega_2)^2}{2}$ 

(c) $\\frac{(I_1\\omega_1+I_2\\omega_2)^2}{2(I_1+I_2)}$ 
...
(d) None of these`,
  },
  {
    ...
    marks: 1,
    optionFontScale: 1.5,
    content: `If a current is passed in a spring, it:
...
(d) remains unchanged`,
  },
  {
    ...
    marks: 1,
    optionFontScale: 1.5,
    content: `A long solenoid carrying a current produces a magnetic field B along its axis. If the current is doubled and the number of turns per cm is halved, the new value of magnetic field will be:
...
(d) $\\frac{B}{2}$`,
  },
  {
    ...
    marks: 1,
    optionFontScale: 1.5,
    content: `Hail storms strike the surface of a frozen lake at $30^\\circ$ with the vertical and rebound at $60^\\circ$ with the vertical. Assuming contact is smooth, the coefficient of restitution is:
...
(d) $e = 3$`,
  },
  {
    ...
    <img
        src="https://i.ibb.co/DH8Sjkwc/17-phys-2025.png"
        alt="rod on incline"
        style="
          float:left;
          width:50%;
...
(d) $\\Delta Q_A = \\Delta Q_B, \\Delta U_A = \\Delta U_B$`,
  },
  {
    ...
    marks: 1,
    optionFontScale: 1.5,
    content: `Two identical coils of self-inductance L are connected in series so close that all flux links both coils. Total self-inductance is:
...
(d) 4L`,
  },
  {
    ...
    marks: 1,
    optionFontScale: 1.5,
    content: `In a moving coil galvanometer, deflection $\\theta$ is related to current i by:
...
(d) $i \\propto \\sqrt{\\theta}$`,
  },
  {
    ...
    marks: 1,
    optionFontScale: 1.5,
    content: `Metals magnetized by orientation of atomic magnetic moments in external fields are:
...
(d) 4.87 mA`,
  ...
  <img
        src="https://i.ibb.co/B2cFt7yq/23-phys-2025.png"
        alt="rod on incline"
        style="
          float:left;
          width:50%;
...
<img
        src="https://i.ibb.co/5XMMBddK/28-phys-2025.png"
        alt="rod on incline"
        style="
          float:left;
          width:50%;
...
<img
        src="https://i.ibb.co/v4RdddzZ/36-phys-2025.png"
        alt="rod on incline"
        style="
          float:left;
          width:50%;
...
<img
        src="https://i.ibb.co/YTyHq4c0/37-phys-2025.png"
        alt="rod on incline"
        style="
          float:left;
          width:60%;
...
(d) $\\frac{\\lambda}{(5-\\sqrt{2})}$`,
  },
  {
    ...
    marks: 1,
    optionFontScale: 1.5,
    content: `A simple pendulum performs SHM about $x = 0$ with an amplitude $a$ and time period $T$. What is the speed of the pendulum at $x = \\frac{a}{2}$ ?
